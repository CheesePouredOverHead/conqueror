...
```
==最后投入使用的是sheepenv5,dqn4,ppo2,model2，其他介绍在“迭代过程”中（展示我的辛勤劳动）。==
...
stack_positions:(30,),stack中不同值分别有几张
...
### step
基础奖励为赋分算法的单张牌赋分（在算法介绍中），在此基础上赢了+50，输了-50.
